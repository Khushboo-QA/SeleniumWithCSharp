## Important note on building and running the solution's projects
### General
Sometimes the newly cloned projects don't run properly (reporting Error in '/' Application).
To fix this:
1. Select the solution in Solution Explorer
2. Open the Package Manager Console (View > Other Windows > Package Manager Console)
3. Run: Update-Package Microsoft.CodeDom.Providers.DotNetCompilerPlatform -r
### NuGet Packages
1. Make sure to delete the contents of the packages directory under the solution's directory
